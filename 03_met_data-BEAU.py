...
st_dt = '2009-09-01'#domains[domain]['st']
ed_dt = '2014-09-30'#domains[domain]['ed']
#########################################################################
...
# start_years_list = list(range(1988,2018))
# end_years_list = list(range(1990,2020))


# for i in range(len(start_years_list)):
    
#     # Define some date info using the two lists
#     date1 = date(start_years_list[i],10,1)
#     date2 = date(end_years_list[i],9,30)
#     st_dt = date1.strftime("%Y-%m-%d")
#     ed_dt = date2.strftime("%Y-%m-%d")
#     print('getting met data for time period '+st_dt+' to '+ed_dt)
#     OUTpath = '/nfs/attic/dfh/2020_NPRB/data/SMinputs/'+domain+'/mm_'+domain+'_'+str(date1.year)+'-'+str(date2.year)+'.dat'
...
## # met data for the calibration time period
# TIME
# choose if want to set 'manual' or 'auto' date 
date_flag = 'manual'
# If you choose 'manual' set your dates below  
st_dt = '2011-10-01'
ed_dt = '2015-09-30'
OUTpath = '/nfs/attic/dfh/2020_NPRB/data/SMinputs/'+domain+'/mm_'+domain+'_'+str(int(st_dt[0:4])+1)+'-'+str(ed_dt[0:4])+'.dat'
